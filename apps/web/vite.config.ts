...
const apiHttpOrigin =
  process.env.VITE_DOCUMINE_API_HTTP_ORIGIN ||
  process.env.DOCUMINE_API_HTTP_ORIGIN ||
  (apiPort ? `http://localhost:${apiPort}` : "");
const apiWsOrigin =
  process.env.VITE_DOCUMINE_API_WS_ORIGIN ||
  process.env.DOCUMINE_API_WS_ORIGIN ||
  (apiPort ? `ws://localhost:${apiPort}` : "");
