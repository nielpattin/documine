  ...
  return (
    <div className="preview-controls">
      <div className="preview-mode-toggle">
        <button
          type="button"
          className={`documine-btn documine-btn--sm ${previewMode === "markdown" ? "documine-btn--primary" : "documine-btn--ghost"}`}
        ...
        <button
          type="button"
          className={`documine-btn documine-btn--sm ${previewMode === "rendered-pdf" ? "documine-btn--primary" : "documine-btn--ghost"}`}
          onClick={() => onPreviewModeChange("rendered-pdf")}
        >
          Print preview
        </button>
      </div>
        ...
        <>
          ...
          {showCopyButton && onCopyRenderedPreview ? (
            <button
              ...
              onClick={onCopyRenderedPreview}
              disabled={renderedPdfLoading}
            >
              {copyPreviewStatus}
            </button>
          ) : null}
          <div className="pdf-preview-zoom-controls" aria-label="Preview zoom controls">
            <button
              ...
              onClick={onRenderedPdfZoomOut}
              disabled={renderedPdfZoom <= RENDERED_PDF_ZOOM_MIN}
            ...
            <button
              type="button"
              className="documine-btn documine-btn--sm documine-btn--ghost pdf-preview-zoom-value"
              onClick={onRenderedPdfZoomReset}
            ...
            <button
              type="button"
              className="documine-btn documine-btn--sm documine-btn--ghost"
              onClick={onRenderedPdfZoomIn}
              disabled={renderedPdfZoom >= RENDERED_PDF_ZOOM_MAX}
      ...
      <button
        type="button"
        className="documine-btn documine-btn--sm documine-btn--ghost preview-close-btn"
